...
public class Movie implements Parcelable {
    ...
    public Movie(FavoriteEntry entry){
        this.posterPath = entry.getPosterPath();
        this.adult = false;
        this.overview = entry.getSynopsis();
        ...
        this.voteCount = 0;
        this.video = false;
        this.voteAverage = entry.getVoteAverage();
    }
    ...
    public Movie(String posterPath, boolean adult, String overview, String releaseDate,
                 ...
                 float popularity, int voteCount, boolean video,
                 float voteAverage) {
